...
// Code node context hints
  ...
  partner: {
    ...
    withdraw: 'Opname',
    withdrawDesc: 'Neem je saldo op naar je Stripe-account (minimum ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬10).',
    availableBalance: 'Beschikbaar saldo',
    withdrawBtn: 'Opnemen',
    withdrawSuccess: 'Opname van ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬{amount} succesvol.',
    withdrawError: 'Opname mislukt.',
    connectFirst: 'Verbind eerst je Stripe-account.',
    minWithdraw: 'Minimum ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬10 vereist voor opname.',
