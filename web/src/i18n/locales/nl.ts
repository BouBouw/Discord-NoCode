...
const nl: TranslationKeys = {
  ...
  botModal: {
    ...
    tokenUpdateHint: 'Leeg laten om het huidige token te behouden',
    tokenUpdateHelp: 'Leeg laten om het huidige token te behouden. Bij wijziging wordt de botcontainer automatisch opnieuw ingezet.',
...
// Code node context hints
  ...
  partner: {
    ...
    subtitle: 'Verwijs gebruikers door en verdien commissie op hun abonnementen.',
    balance: 'Saldo',
    totalEarned: 'Totaal verdiend',
    referralsCount: 'Verwijzingen',
    referralLink: 'Verwijzingslink',
    referralDesc: 'Deel deze link. Geregistreerde gebruikers krijgen 10% korting en jij verdient 10% commissie.',
    stripeConnect: 'Stripe-account',
    stripeConnectDesc: 'Verbind je Stripe-account om commissiebetalingen te ontvangen.',
    connected: 'Verbonden',
    payoutsEnabled: 'Uitbetalingen actief',
    connectStripe: 'Stripe verbinden',
    withdraw: 'Opname',
    withdrawDesc: 'Neem je saldo op naar je Stripe-account (minimum ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã¢â‚¬Â¦Ãƒâ€šÃ‚Â¡ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¬10).',
    availableBalance: 'Beschikbaar saldo',
    withdrawBtn: 'Opnemen',
    withdrawSuccess: 'Opname van ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã¢â‚¬Â¦Ãƒâ€šÃ‚Â¡ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¬{amount} succesvol.',
    withdrawError: 'Opname mislukt.',
    connectFirst: 'Verbind eerst je Stripe-account.',
    minWithdraw: 'Minimum ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã¢â‚¬Â¦Ãƒâ€šÃ‚Â¡ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¬10 vereist voor opname.',
    referrals: 'Verwijzingen',
    noReferrals: 'Nog geen verwijzingen.',
    email: 'E-mail',
    date: 'Datum',
    earnings: 'Commissies',
    noEarnings: 'Nog geen commissies.',
    amount: 'Bedrag',
    description: 'Beschrijving',
    withdrawals: 'Opnamegeschiedenis',
    statusCompleted: 'Voltooid',
    statusPending: 'In behandeling',
    statusFailed: 'Mislukt',
    loadError: 'Fout bij laden partnergegevens.',
    connectError: 'Stripe-verbindingsfout.',
  },
  onboarding: {
    cat_welcome: 'Welcome',
