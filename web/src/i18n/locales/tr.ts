...
const tr: TranslationKeys = {
  ...
  botModal: {
    ...
    tokenUpdateHint: 'Mevcut jetonu korumak iÃƒÆ’Ã‚Â¯Ãƒâ€šÃ‚Â¿Ãƒâ€šÃ‚Â½in bos birakin',
    tokenUpdateHelp: 'Mevcut jetonu korumak iÃƒÆ’Ã‚Â¯Ãƒâ€šÃ‚Â¿Ãƒâ€šÃ‚Â½in bos birakin. Degistirilirse bot konteyneri otomatik olarak yeniden dagitilacaktir.',
...
// Code node context hints
  ...
  partner: {
    title: 'OrtaklÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€šÃ‚Â±k ProgramÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€šÃ‚Â±',
    subtitle: 'KullanÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€šÃ‚Â±cÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€šÃ‚Â±larÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€šÃ‚Â± yÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¶nlendirin ve aboneliklerinden komisyon kazanÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€šÃ‚Â±n.',
    balance: 'Bakiye',
    totalEarned: 'Toplam kazanÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â§',
    referralsCount: 'YÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¶nlendirmeler',
    referralLink: 'YÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¶nlendirme baÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€¦Ã‚Â¸lantÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€šÃ‚Â±sÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€šÃ‚Â±',
    referralDesc: 'Bu baÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€¦Ã‚Â¸lantÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€šÃ‚Â±yÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€šÃ‚Â± paylaÃƒÆ’Ã¢â‚¬Â¦Ãƒâ€¦Ã‚Â¸ÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€šÃ‚Â±n. KayÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€šÃ‚Â±t olan kullanÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€šÃ‚Â±cÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€šÃ‚Â±lar %10 indirim alÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€šÃ‚Â±r ve siz %10 komisyon kazanÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€šÃ‚Â±rsÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€šÃ‚Â±nÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€šÃ‚Â±z.',
    stripeConnect: 'Stripe HesabÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€šÃ‚Â±',
    stripeConnectDesc: 'Komisyon ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¶demelerini almak iÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â§in Stripe hesabÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€šÃ‚Â±nÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€šÃ‚Â±zÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€šÃ‚Â± baÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€¦Ã‚Â¸layÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€šÃ‚Â±n.',
    connected: 'BaÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€¦Ã‚Â¸lÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€šÃ‚Â±',
    payoutsEnabled: 'ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“demeler etkin',
    connectStripe: 'Stripe BaÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€¦Ã‚Â¸la',
    withdraw: 'ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¡ekim',
    withdrawDesc: 'Bakiyenizi Stripe hesabÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€šÃ‚Â±nÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€šÃ‚Â±za ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â§ekin (minimum 10ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬).',
    availableBalance: 'KullanÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€šÃ‚Â±labilir bakiye',
    withdrawBtn: 'ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¡ek',
    withdrawSuccess: '{amount}ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â§ekim baÃƒÆ’Ã¢â‚¬Â¦Ãƒâ€¦Ã‚Â¸arÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€šÃ‚Â±lÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€šÃ‚Â±.',
    withdrawError: 'ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¡ekim baÃƒÆ’Ã¢â‚¬Â¦Ãƒâ€¦Ã‚Â¸arÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€šÃ‚Â±sÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€šÃ‚Â±z.',
    connectFirst: 'ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“nce Stripe hesabÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€šÃ‚Â±nÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€šÃ‚Â±zÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€šÃ‚Â± baÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€¦Ã‚Â¸layÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€šÃ‚Â±n.',
    minWithdraw: 'ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¡ekim iÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â§in minimum 10ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ gerekli.',
    referrals: 'YÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¶nlendirmeler',
    noReferrals: 'HenÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¼z yÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¶nlendirme yok.',
    email: 'E-posta',
    date: 'Tarih',
    earnings: 'Komisyonlar',
    noEarnings: 'HenÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¼z komisyon yok.',
    amount: 'Tutar',
    description: 'AÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â§ÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€šÃ‚Â±klama',
    withdrawals: 'ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¡ekim geÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â§miÃƒÆ’Ã¢â‚¬Â¦Ãƒâ€¦Ã‚Â¸i',
    statusCompleted: 'TamamlandÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€šÃ‚Â±',
    statusPending: 'Bekliyor',
    statusFailed: 'BaÃƒÆ’Ã¢â‚¬Â¦Ãƒâ€¦Ã‚Â¸arÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€šÃ‚Â±sÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€šÃ‚Â±z',
    loadError: 'Ortak verileri yÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¼klenemedi.',
    connectError: 'Stripe baÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€¦Ã‚Â¸lantÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€šÃ‚Â± hatasÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€šÃ‚Â±.',
  },
  onboarding: {
    cat_welcome: 'Welcome',
