...
const pl: TranslationKeys = {
  ...
  dashboard: {
    ...
    selected: 'selected',
    errorBanner: 'bot(s) in error ? view details',
  ...
  botModal: {
    ...
    tokenUpdateHint: 'Pozostaw puste, aby zachowac biezacy token',
    tokenUpdateHelp: 'Pozostaw puste, aby zachowac biezacy token. Po zmianie kontener bota zostanie automatycznie wdrozony ponownie.',
  ...
  landing: {
    ...
    logoutBtn: 'Log out',
    heroTitle: 'Discord Automation ? No-Code',
    ...
    dualDesc: 'Switch between clean light mode and immersive dark mode ? both crafted for excellence.',
    ...
    feat1Desc: 'Create complex workflows visually. Conditions, loops, delays, branching ? it\'s all there.',
    ...
    feat4Desc: 'Define slash commands visually with parameters, permissions, and auto-complete ? no boilerplate needed.',
    popular: 'Popular',
    stepsLabel: 'Process',
    ...
    footer: '? 2026 DisFlow ? All rights reserved',
    ...
    kb4Desc: 'From a single server to thousands ? DisFlow scales automatically with your community.',
    ...
    test3Quote: 'As a developer, I appreciate the power under the hood. Full DiscordJS v14 access through a visual interface ? brilliant.',
    test3Name: 'Marcus T.',
    test3Role: 'Developer',
    ...
    faq1A: 'DisFlow is a no-code platform that lets you build, deploy, and manage Discord bots using a visual drag-and-drop workflow editor ? no programming required.',
    ...
    faq3A: 'Each bot runs in its own isolated Docker container. When you click Deploy, your workflow is bundled and launched automatically ? the whole process takes under 30 seconds.',
    ...
    faq6A: 'DisFlow covers the complete DiscordJS v14 API ? messages, embeds, reactions, roles, moderation, slash commands, modals, buttons, select menus, voice events, and much more.',
...
// Code node context hints
  ...
  partner: {
    ...
    subtitle: 'Polecaj uzytkownikÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â³w i zarabiaj prowizje od ich subskrypcji.',
    balance: 'Saldo',
    totalEarned: 'Lacznie zarobiono',
    referralsCount: 'Polecenia',
    referralLink: 'Link polecajacy',
    referralDesc: 'Udostepnij ten link. Zarejestrowani uzytkownicy otrzymuja 10% znizki, a ty zarabiasz 10% prowizji.',
    stripeConnect: 'Konto Stripe',
    stripeConnectDesc: 'Polacz konto Stripe, aby otrzymywac platnosci prowizyjne.',
    connected: 'Polaczono',
    payoutsEnabled: 'Wyplaty wlaczone',
    connectStripe: 'Polacz Stripe',
    withdraw: 'Wyplata',
    withdrawDesc: 'Wyplac saldo na konto Stripe (minimum 10ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€¦Ã‚Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¬).',
    availableBalance: 'Dostepne saldo',
    withdrawBtn: 'Wyplac',
    withdrawSuccess: 'Wyplata {amount}ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€¦Ã‚Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¬ zakonczona sukcesem.',
    withdrawError: 'Wyplata nie powiodla sie.',
    connectFirst: 'Najpierw polacz konto Stripe.',
    minWithdraw: 'Minimum 10ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€¦Ã‚Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¬ do wyplaty.',
    referrals: 'Polecenia',
    noReferrals: 'Brak polecen.',
    email: 'Email',
    date: 'Data',
    earnings: 'Prowizje',
    noEarnings: 'Brak prowizji.',
    amount: 'Kwota',
    description: 'Opis',
    withdrawals: 'Historia wyplat',
    statusCompleted: 'Zakonczono',
    statusPending: 'Oczekuje',
    statusFailed: 'Nieudane',
    loadError: 'Blad ladowania danych partnera.',
    connectError: 'Blad polaczenia Stripe.',
  },
  onboarding: {
    cat_welcome: 'Welcome',
