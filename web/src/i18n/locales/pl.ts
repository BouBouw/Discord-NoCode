...
// Code node context hints
  ...
  partner: {
    ...
    subtitle: 'Polecaj uzytkownikÃƒÆ’Ã‚Â³w i zarabiaj prowizje od ich subskrypcji.',
    balance: 'Saldo',
    ...
    withdraw: 'Wyplata',
    withdrawDesc: 'Wyplac saldo na konto Stripe (minimum 10ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬).',
    availableBalance: 'Dostepne saldo',
    withdrawBtn: 'Wyplac',
    withdrawSuccess: 'Wyplata {amount}ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ zakonczona sukcesem.',
    withdrawError: 'Wyplata nie powiodla sie.',
    connectFirst: 'Najpierw polacz konto Stripe.',
    minWithdraw: 'Minimum 10ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ do wyplaty.',
    referrals: 'Polecenia',
