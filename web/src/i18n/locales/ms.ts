...
// Code node context hints
  ...
  partner: {
    ...
    withdrawDesc: 'Keluarkan baki ke akaun Stripe anda (minimum 10ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬).',
    availableBalance: 'Baki tersedia',
    withdrawBtn: 'Keluarkan',
    withdrawSuccess: 'Pengeluaran {amount}ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ berjaya.',
    withdrawError: 'Pengeluaran gagal.',
    connectFirst: 'Sambungkan akaun Stripe dahulu.',
    minWithdraw: 'Minimum 10ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ untuk pengeluaran.',
    referrals: 'Rujukan',
