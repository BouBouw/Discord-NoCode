...
const ms: TranslationKeys = {
  ...
  botModal: {
    ...
    tokenUpdateHint: 'Biarkan kosong untuk mengekalkan token semasa',
    tokenUpdateHelp: 'Biarkan kosong untuk mengekalkan token semasa. Jika ditukar, kontena bot akan digunakan semula secara automatik.',
...
// Code node context hints
  ...
  partner: {
    title: 'Program Rakan Kongsi',
    subtitle: 'Rujuk pengguna dan dapatkan komisen daripada langganan mereka.',
    balance: 'Baki',
    totalEarned: 'Jumlah diperoleh',
    referralsCount: 'Rujukan',
    referralLink: 'Pautan rujukan',
    referralDesc: 'Kongsi pautan ini. Pengguna yang mendaftar mendapat diskaun 10% dan anda mendapat komisen 10%.',
    stripeConnect: 'Akaun Stripe',
    stripeConnectDesc: 'Sambungkan akaun Stripe anda untuk menerima bayaran komisen.',
    connected: 'Disambung',
    payoutsEnabled: 'Pembayaran aktif',
    connectStripe: 'Sambung Stripe',
    withdraw: 'Pengeluaran',
    withdrawDesc: 'Keluarkan baki ke akaun Stripe anda (minimum 10ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã¢â‚¬Â¦Ãƒâ€šÃ‚Â¡ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¬).',
    availableBalance: 'Baki tersedia',
    withdrawBtn: 'Keluarkan',
    withdrawSuccess: 'Pengeluaran {amount}ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã¢â‚¬Â¦Ãƒâ€šÃ‚Â¡ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¬ berjaya.',
    withdrawError: 'Pengeluaran gagal.',
    connectFirst: 'Sambungkan akaun Stripe dahulu.',
    minWithdraw: 'Minimum 10ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã¢â‚¬Â¦Ãƒâ€šÃ‚Â¡ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¬ untuk pengeluaran.',
    referrals: 'Rujukan',
    noReferrals: 'Belum ada rujukan.',
    email: 'E-mel',
    date: 'Tarikh',
    earnings: 'Komisen',
    noEarnings: 'Belum ada komisen.',
    amount: 'Jumlah',
    description: 'Penerangan',
    withdrawals: 'Sejarah pengeluaran',
    statusCompleted: 'Selesai',
    statusPending: 'Menunggu',
    statusFailed: 'Gagal',
    loadError: 'Gagal memuatkan data rakan kongsi.',
    connectError: 'Ralat sambungan Stripe.',
  },
  onboarding: {
    cat_welcome: 'Welcome',
