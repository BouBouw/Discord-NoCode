...
const id: TranslationKeys = {
  ...
  botModal: {
    ...
    tokenUpdateHint: 'Biarkan kosong untuk mempertahankan token saat ini',
    tokenUpdateHelp: 'Biarkan kosong untuk mempertahankan token saat ini. Jika diubah, kontainer bot akan di-deploy ulang secara otomatis.',
