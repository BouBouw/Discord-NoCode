...
const de: TranslationKeys = {
  ...
  botModal: {
    ...
    tokenUpdateHelp: 'Leer lassen, um den aktuellen Token beizubehalten. Bei ÃƒÆ’Ã‚Â¯Ãƒâ€šÃ‚Â¿Ãƒâ€šÃ‚Â½nderung wird der Bot-Container automatisch neu bereitgestellt.',
...
// Code node context hints
  ...
  partner: {
    ...
    withdraw: 'Auszahlung',
    withdrawDesc: 'Zahlen Sie Ihr Guthaben auf Ihr Stripe-Konto aus (Minimum 10ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬).',
    availableBalance: 'VerfÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¼gbares Guthaben',
    withdrawBtn: 'Auszahlen',
    withdrawSuccess: 'Auszahlung von {amount}ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ erfolgreich.',
    withdrawError: 'Auszahlung fehlgeschlagen.',
    connectFirst: 'Verbinden Sie zuerst Ihr Stripe-Konto.',
    minWithdraw: 'Minimum 10ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ fÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¼r Auszahlung erforderlich.',
