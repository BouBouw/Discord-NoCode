...
const de: TranslationKeys = {
  ...
  botModal: {
    ...
    tokenUpdateHint: 'Leer lassen, um den aktuellen Token beizubehalten',
    tokenUpdateHelp: 'Leer lassen, um den aktuellen Token beizubehalten. Bei ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½nderung wird der Bot-Container automatisch neu bereitgestellt.',
...
// Code node context hints
  ...
  partner: {
    ...
    subtitle: 'Empfehlen Sie Benutzer und verdienen Sie Provisionen auf deren Abonnements.',
    balance: 'Guthaben',
    totalEarned: 'Gesamt verdient',
    referralsCount: 'Empfehlungen',
    referralLink: 'Empfehlungslink',
    referralDesc: 'Teilen Sie diesen Link. Registrierte Benutzer erhalten 10% Rabatt und Sie verdienen 10% Provision.',
    stripeConnect: 'Stripe-Konto',
    stripeConnectDesc: 'Verbinden Sie Ihr Stripe-Konto, um Provisionszahlungen zu erhalten.',
    connected: 'Verbunden',
    payoutsEnabled: 'Auszahlungen aktiviert',
    connectStripe: 'Stripe verbinden',
    withdraw: 'Auszahlung',
    withdrawDesc: 'Zahlen Sie Ihr Guthaben auf Ihr Stripe-Konto aus (Minimum 10ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã¢â‚¬Â¦Ãƒâ€šÃ‚Â¡ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¬).',
    availableBalance: 'VerfÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¼gbares Guthaben',
    withdrawBtn: 'Auszahlen',
    withdrawSuccess: 'Auszahlung von {amount}ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã¢â‚¬Â¦Ãƒâ€šÃ‚Â¡ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¬ erfolgreich.',
    withdrawError: 'Auszahlung fehlgeschlagen.',
    connectFirst: 'Verbinden Sie zuerst Ihr Stripe-Konto.',
    minWithdraw: 'Minimum 10ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã¢â‚¬Â¦Ãƒâ€šÃ‚Â¡ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¬ fÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¼r Auszahlung erforderlich.',
    referrals: 'Empfehlungen',
    noReferrals: 'Noch keine Empfehlungen.',
    email: 'E-Mail',
    date: 'Datum',
    earnings: 'Provisionen',
    noEarnings: 'Noch keine Provisionen.',
    amount: 'Betrag',
    ...
    loadError: 'Fehler beim Laden der Partnerdaten.',
    connectError: 'Stripe-Verbindungsfehler.',
  },
  onboarding: {
    cat_welcome: 'Welcome',
