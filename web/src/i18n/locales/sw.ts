...
const sw: TranslationKeys = {
  ...
  botModal: {
    ...
    tokenUpdateHint: 'Acha tupu ili kubakisha tokeni ya sasa',
    tokenUpdateHelp: 'Acha tupu ili kubakisha tokeni ya sasa. Ikibadilishwa, chombo cha bot kitawekwa upya kiotomatiki.',
