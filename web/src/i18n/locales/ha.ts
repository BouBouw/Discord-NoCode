...
const ha: TranslationKeys = {
  ...
  botModal: {
    ...
    tokenUpdateHint: 'Bar da babu komai don kiyaye token na yanzu',
    tokenUpdateHelp: 'Bar da babu komai don kiyaye token na yanzu. Idan an canza, za a sake tura akwatin bot ta atomatik.',
