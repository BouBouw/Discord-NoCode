...
const pt: TranslationKeys = {
  ...
  botModal: {
    ...
    tokenUpdateHelp: 'Deixe vazio para manter o token atual. Se alterado, o contÃƒÆ’Ã‚Â¯Ãƒâ€šÃ‚Â¿Ãƒâ€šÃ‚Â½iner do bot serÃƒÆ’Ã‚Â¯Ãƒâ€šÃ‚Â¿Ãƒâ€šÃ‚Â½ reimplantado automaticamente.',
...
// Code node context hints
  ...
  partner: {
    ...
    subtitle: 'Indique usuÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡rios e ganhe comissÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Âµes em suas assinaturas.',
    balance: 'Saldo',
    totalEarned: 'Total ganho',
    referralsCount: 'IndicaÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â§ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Âµes',
    referralLink: 'Link de indicaÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â§ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â£o',
    referralDesc: 'Compartilhe este link. UsuÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡rios cadastrados ganham 10% de desconto e vocÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Âª ganha 10% de comissÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â£o.',
    stripeConnect: 'Conta Stripe',
    stripeConnectDesc: 'Conecte sua conta Stripe para receber pagamentos de comissÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â£o.',
    connected: 'Conectado',
    payoutsEnabled: 'Pagamentos habilitados',
    connectStripe: 'Conectar Stripe',
    withdraw: 'Saque',
    withdrawDesc: 'Saque seu saldo para sua conta Stripe (mÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â­nimo 10ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬).',
    availableBalance: 'Saldo disponÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â­vel',
    withdrawBtn: 'Sacar',
    withdrawSuccess: 'Saque de {amount}ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ realizado com sucesso.',
    withdrawError: 'Erro no saque.',
    connectFirst: 'Conecte sua conta Stripe primeiro.',
    minWithdraw: 'MÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â­nimo de 10ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ necessÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡rio para saque.',
    referrals: 'IndicaÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â§ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Âµes',
    noReferrals: 'Nenhuma indicaÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â§ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â£o ainda.',
    email: 'Email',
    date: 'Data',
    earnings: 'ComissÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Âµes',
    noEarnings: 'Nenhuma comissÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â£o ainda.',
    amount: 'Valor',
    description: 'DescriÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â§ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â£o',
    withdrawals: 'HistÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³rico de saques',
    statusCompleted: 'ConcluÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â­do',
    statusPending: 'Pendente',
    statusFailed: 'Falhou',
    loadError: 'Erro ao carregar dados do parceiro.',
    connectError: 'Erro de conexÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â£o Stripe.',
  },
  onboarding: {
    cat_welcome: 'Welcome',
