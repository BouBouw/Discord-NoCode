...
const en: TranslationKeys = {
  ...
  botModal: {
    ...
    tokenUpdateHint: 'Leave empty to keep current token',
    tokenUpdateHelp: 'Leave empty to keep the current token. If changed, the bot container will be automatically redeployed.',
...
// Code node context hints
    ...
    customStatusActivity: '✏️ Custom Status',
    // Button styles
  ...
  partner: {
    ...
    withdraw: 'Withdraw',
    withdrawDesc: 'Withdraw your balance to your Stripe account (minimum €10).',
    availableBalance: 'Available balance',
    withdrawBtn: 'Withdraw',
    withdrawSuccess: 'Withdrawal of €{amount} completed successfully.',
    withdrawError: 'Withdrawal failed.',
    connectFirst: 'Connect your Stripe account first.',
    minWithdraw: 'Minimum €10 required for withdrawal.',
    referrals: 'Referrals',
