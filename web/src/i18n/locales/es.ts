...
const es: TranslationKeys = {
  ...
  botModal: {
    ...
    tokenUpdateHint: 'Dejar vacÃƒÆ’Ã‚Â¯Ãƒâ€šÃ‚Â¿Ãƒâ€šÃ‚Â½o para mantener el token actual',
    tokenUpdateHelp: 'Dejar vacÃƒÆ’Ã‚Â¯Ãƒâ€šÃ‚Â¿Ãƒâ€šÃ‚Â½o para mantener el token actual. Si se cambia, el contenedor del bot se redesplegarÃƒÆ’Ã‚Â¯Ãƒâ€šÃ‚Â¿Ãƒâ€šÃ‚Â½ automÃƒÆ’Ã‚Â¯Ãƒâ€šÃ‚Â¿Ãƒâ€šÃ‚Â½ticamente.',
...
// Code node context hints
  ...
  partner: {
    ...
    referralDesc: 'Comparte este enlace. Los usuarios registrados obtienen 10% de descuento y tÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Âº ganas 10% de comisiÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n.',
    stripeConnect: 'Cuenta Stripe',
    stripeConnectDesc: 'Conecta tu cuenta Stripe para recibir pagos de comisiÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n.',
    connected: 'Conectado',
    payoutsEnabled: 'Pagos habilitados',
    connectStripe: 'Conectar Stripe',
    withdraw: 'Retiro',
    withdrawDesc: 'Retira tu saldo a tu cuenta Stripe (mÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â­nimo 10ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬).',
    availableBalance: 'Saldo disponible',
    withdrawBtn: 'Retirar',
    withdrawSuccess: 'Retiro de {amount}ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ completado con ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©xito.',
    withdrawError: 'Error en el retiro.',
    connectFirst: 'Conecta tu cuenta Stripe primero.',
    minWithdraw: 'MÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â­nimo 10ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ requerido para retiro.',
    referrals: 'Referidos',
    noReferrals: 'Sin referidos aÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Âºn.',
    email: 'Email',
    date: 'Fecha',
    earnings: 'Comisiones',
    noEarnings: 'Sin comisiones aÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Âºn.',
    amount: 'Monto',
    description: 'DescripciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n',
    withdrawals: 'Historial de retiros',
    statusCompleted: 'Completado',
    statusPending: 'Pendiente',
    statusFailed: 'Fallido',
    loadError: 'Error al cargar datos de socio.',
    connectError: 'Error de conexiÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n Stripe.',
  },
  onboarding: {
    cat_welcome: 'Welcome',
