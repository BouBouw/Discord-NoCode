...
// Code node context hints
  ...
  partner: {
    ...
    subtitle: 'RecomandÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€ Ã¢â‚¬â„¢ utilizatori ÃƒÆ’Ã‹â€ ÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢i cÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‹â€ ÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢tigÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€ Ã¢â‚¬â„¢ comisioane din abonamentele lor.',
    balance: 'Sold',
    totalEarned: 'Total cÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‹â€ ÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢tigat',
    referralsCount: 'RecomandÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€ Ã¢â‚¬â„¢ri',
    referralLink: 'Link de recomandare',
    referralDesc: 'Distribuie acest link. Utilizatorii ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â®nregistraÃƒÆ’Ã‹â€ ÃƒÂ¢Ã¢â€šÂ¬Ã‚Âºi primesc 10% reducere ÃƒÆ’Ã‹â€ ÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢i tu cÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‹â€ ÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢tigi 10% comision.',
    stripeConnect: 'Cont Stripe',
    stripeConnectDesc: 'ConecteazÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€ Ã¢â‚¬â„¢ contul Stripe pentru a primi plÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã‹â€ ÃƒÂ¢Ã¢â€šÂ¬Ã‚Âºile de comision.',
    connected: 'Conectat',
    payoutsEnabled: 'PlÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã‹â€ ÃƒÂ¢Ã¢â€šÂ¬Ã‚Âºi activate',
    connectStripe: 'ConecteazÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€ Ã¢â‚¬â„¢ Stripe',
    withdraw: 'Retragere',
    withdrawDesc: 'Retrage soldul ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â®n contul tÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€ Ã¢â‚¬â„¢u Stripe (minim 10ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬).',
    availableBalance: 'Sold disponibil',
    withdrawBtn: 'Retrage',
    withdrawSuccess: 'Retragere de {amount}ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ finalizatÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€ Ã¢â‚¬â„¢.',
    withdrawError: 'Retragerea a eÃƒÆ’Ã‹â€ ÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢uat.',
    connectFirst: 'ConecteazÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€ Ã¢â‚¬â„¢ mai ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â®ntÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢i contul Stripe.',
    minWithdraw: 'Minim 10ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ pentru retragere.',
    referrals: 'RecomandÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€ Ã¢â‚¬â„¢ri',
    noReferrals: 'Nicio recomandare ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â®ncÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€ Ã¢â‚¬â„¢.',
    email: 'Email',
    date: 'Data',
    earnings: 'Comisioane',
    noEarnings: 'Niciun comision ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â®ncÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€ Ã¢â‚¬â„¢.',
    amount: 'SumÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€ Ã¢â‚¬â„¢',
    description: 'Descriere',
    withdrawals: 'Istoric retrageri',
    statusCompleted: 'Finalizat',
    statusPending: 'ÃƒÆ’Ã†â€™Ãƒâ€¦Ã‚Â½n aÃƒÆ’Ã‹â€ ÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢teptare',
    statusFailed: 'EÃƒÆ’Ã‹â€ ÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢uat',
    loadError: 'Eroare la ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â®ncÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€ Ã¢â‚¬â„¢rcarea datelor partenerului.',
