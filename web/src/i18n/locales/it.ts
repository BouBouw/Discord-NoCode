...
const it: TranslationKeys = {
  ...
  botModal: {
    ...
    tokenUpdateHelp: 'Lascia vuoto per mantenere il token attuale. Se modificato, il container del bot verrÃƒÆ’Ã‚Â¯Ãƒâ€šÃ‚Â¿Ãƒâ€šÃ‚Â½ ridistribuito automaticamente.',
...
// Code node context hints
  ...
  partner: {
    ...
    withdraw: 'Prelievo',
    withdrawDesc: 'Preleva il saldo sul tuo account Stripe (minimo 10ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬).',
    availableBalance: 'Saldo disponibile',
    withdrawBtn: 'Preleva',
    withdrawSuccess: 'Prelievo di {amount}ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ completato.',
    withdrawError: 'Prelievo fallito.',
    connectFirst: 'Collega prima il tuo account Stripe.',
    minWithdraw: 'Minimo 10ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ per il prelievo.',
    referrals: 'Referral',
