...
const it: TranslationKeys = {
  ...
  botModal: {
    ...
    tokenUpdateHint: 'Lascia vuoto per mantenere il token attuale',
    tokenUpdateHelp: 'Lascia vuoto per mantenere il token attuale. Se modificato, il container del bot verrÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½ ridistribuito automaticamente.',
...
// Code node context hints
  ...
  partner: {
    ...
    subtitle: 'Invita utenti e guadagna commissioni sui loro abbonamenti.',
    balance: 'Saldo',
    totalEarned: 'Totale guadagnato',
    referralsCount: 'Referral',
    referralLink: 'Link di referral',
    referralDesc: 'Condividi questo link. Gli utenti registrati ottengono il 10% di sconto e tu guadagni il 10% di commissione.',
    stripeConnect: 'Account Stripe',
    stripeConnectDesc: 'Collega il tuo account Stripe per ricevere i pagamenti.',
    connected: 'Collegato',
    payoutsEnabled: 'Pagamenti abilitati',
    connectStripe: 'Collega Stripe',
    withdraw: 'Prelievo',
    withdrawDesc: 'Preleva il saldo sul tuo account Stripe (minimo 10ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã¢â‚¬Â¦Ãƒâ€šÃ‚Â¡ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¬).',
    availableBalance: 'Saldo disponibile',
    withdrawBtn: 'Preleva',
    withdrawSuccess: 'Prelievo di {amount}ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã¢â‚¬Â¦Ãƒâ€šÃ‚Â¡ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¬ completato.',
    withdrawError: 'Prelievo fallito.',
    connectFirst: 'Collega prima il tuo account Stripe.',
    minWithdraw: 'Minimo 10ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã¢â‚¬Â¦Ãƒâ€šÃ‚Â¡ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¬ per il prelievo.',
    referrals: 'Referral',
    noReferrals: 'Nessun referral ancora.',
    email: 'Email',
    date: 'Data',
    earnings: 'Commissioni',
    noEarnings: 'Nessuna commissione ancora.',
    amount: 'Importo',
    ...
    loadError: 'Errore nel caricamento dati partner.',
    connectError: 'Errore connessione Stripe.',
  },
  onboarding: {
    cat_welcome: 'Welcome',
